    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Full name', max_length=128, verbose_name='name')),
                ('short_name', models.CharField(help_text='Nickname, first name, or short name. Optional.', max_length=48, blank=True)),
