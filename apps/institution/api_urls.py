...
from institution.api import FacultyList, FacultyDetail, InstitutionDetail, CheckInstitutionValidity


urlpatterns = [
    url(r'^edit/(?P<entity_id>[^/]+)$', InstitutionDetail.as_view(), name='api_institution_detail'),
    url(r'^check$', CheckInstitutionValidity.as_view(), name='api_check_institution_validity'),
