...
from signing.api import SymmetricKeyListView, SymmetricKeyDetailView, PublicKeyDetailView, ChangeIssuerSignerView, SetIssuerSignerView
...
urlpatterns = [
    ...
    url(r'^change-signer$', ChangeIssuerSignerView.as_view(), name='signing_change_signer'),
