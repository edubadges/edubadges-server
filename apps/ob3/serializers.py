...
class IdentityObjectSerializer(serializers.Serializer):
    type = serializers.CharField(read_only=True, default='IdentityObject')
...
class AchievementSerializer(OmitNoneFieldsMixin, serializers.Serializer):
    ...
    id = serializers.URLField()
    type = serializers.ListField(child=serializers.CharField(), read_only=True, default=['Achievement'])
...
class AchievementSubjectSerializer(OmitNoneFieldsMixin, serializers.Serializer):
    ...
    type = serializers.ListField(child=serializers.CharField(), read_only=True, default=['AchievementSubject'])
...
class CredentialSerializer(OmitNoneFieldsMixin, serializers.Serializer):
    ...
    validFrom = serializers.DateTimeField(
        source='valid_from', required=False, allow_null=True, default_timezone=timezone.utc
    )
    validUntil = serializers.DateTimeField(
        source='valid_until', required=False, allow_null=True, default_timezone=timezone.utc
    )
