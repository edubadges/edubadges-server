...
from ob3.api import CredentialsView, OffersView

urlpatterns = [
    url(r'^v1/credentials', CredentialsView.as_view(), name='credentials'),
    url(r'^v1/offers', OffersView.as_view(), name='credentials'),
