...
SURFCONEXT_DOMAIN_URL = os.environ.get('SURFCONEXT_DOMAIN_URL', 'https://oidc.test.surfconext.nl')
...
SURF_CONEXT_CLIENT = os.environ.get('SURF_CONEXT_CLIENT', "http@//localhost.edubadges.nl")
