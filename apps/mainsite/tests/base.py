...
class SetupHelper(object):
    ...
    def _add_surfconext_socialaccount(self, user):
        ...
        socialaccount = SocialAccount(
            extra_data=extra_data, uid=random_surfconext_id, provider='surf_conext', user=user
        )
        socialaccount.save()
    ...
    def setup_general_terms(self):
        ...
        terms_service_agreement_employee, _ = Terms.objects.get_or_create(
            version=1, institution=None, terms_type=Terms.TYPE_SERVICE_AGREEMENT_EMPLOYEE
        )
        TermsUrl.objects.get_or_create(
