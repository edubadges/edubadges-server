...
class JSONComponentView(VersionedObjectMixin, GenericAPIView, SlugToEntityIdRedirectMixin):
    """
...
class ImagePropertyDetailView(GenericAPIView, SlugToEntityIdRedirectMixin):
    permission_classes = (permissions.AllowAny,)
