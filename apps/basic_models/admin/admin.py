...
class AutoGroupMeta(ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        meta_fields = ("is_active", "created_at", "created_by", "updated_at", "updated_by")
        meta_grouped = []
        ...
        for fieldset in fieldsets:
            ...
            field_options["fields"] = [
                field_name for field_name in field_options["fields"] if field_name not in meta_fields
            ]
...
class DefaultModelAdmin(ActiveModelAdmin, UserModelAdmin, TimestampedModelAdmin):
    ...
    fieldsets = (
        (
            "Meta",
            {"fields": ("is_active", "created_at", "created_by", "updated_at", "updated_by"), "classes": ("collapse",)},
        ),
    )
