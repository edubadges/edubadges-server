...
var MenuItem = React.createClass({displayName: 'MenuItem',
  ...
  render: function(){
    ...
    if (this.props.children.length > 0) {
      expandButton = React.createElement("span", {className: "fa arrow"})
      anyChildren = React.createElement(MenuList, {items: this.props.children, clName: "nav nav-second-level", key: "nested-menu"})
    }
    return (
      React.createElement("li", {className: this.state.expanded ? 'nav-menu-item expanded-true active' : 'nav-menu-item expanded-false'}, 
        React.createElement("a", {href: this.props.url, onClick: this.handleClick}, React.createElement("i", {className: 'fa fa-fw ' + this.props.iconClass}), this.props.title, expandButton), 
          anyChildren
      )
    );
  }
...
var MenuList = React.createClass({displayName: 'MenuList',
  render: function(){
    var items = this.props.items.map(function(item, i) {
      return (React.createElement(MenuItem, {url: item.url, key: 'menu-item-' + i, title: item.title, iconClass: item.icon, children: item.children}));
    }.bind(this))
    return (
      React.createElement("ul", {className: this.props.clName}, 
        items
      )
    );
  }
  ...
  render: function() {
    return (
      React.createElement("div", {className: "sidebar-nav navbar-collapse"}, 
        React.createElement(MenuList, {items: this.props.items, clName: "nav"})
      )
    )
  }
});
